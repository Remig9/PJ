...
export default ({ navigation }) => {
  ...
  drink.priceLarge =
    drink?.sizes?.find((size) => size?.size?.size_category === "SMALL")?.price
      .price || 0;
  // drink.priceMedium = drink.sizes.find(size => size.size.size_category === 'SMALL')?.price.price || 0
  // drink.priceSmall = item.sizes.find(size => size.size.size_type === 'Small')?.price.price || 0
